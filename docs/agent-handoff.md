...
- O turnaround foi inspecionado e **reprovado no gate visual**: a iteração mais recente estreitou membros, melhorou a leitura do tênis e retirou volume indevido dos olhos, mas rosto, jaqueta, calçado e proporção frente/3⁄4 continuam blockout. `player_v1.json` registra `BLOCKOUT_NOT_READY`, com 3.640 triângulos, escala técnica 1,600 m e pés em 0. Seguirei refinando a malha antes de rigar. Não tratar os previews como asset aprovado.
