...
CREAM = mat("charizard_belly_cream", (0.93, 0.66, 0.30), 0.72)
WING_MEMBRANE = mat("charizard_wing_membrane", (0.12, 0.27, 0.34), 0.76)
CLAW = mat("charizard_claw_ivory", (0.96, 0.82, 0.55), 0.62)
