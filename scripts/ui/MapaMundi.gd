...
const COR_POR_CHAR := {
	...
	# mapa desenhava o fundo do mar como um campo — o mesmo furo que a Ilha do
	# Deserto teve em 05/09.
	"≡": Color(0.86, 0.80, 0.59),
	"±": Color(0.84, 0.78, 0.57),
	"φ": Color(0.33, 0.48, 0.35),
	"≈": Color(0.07, 0.17, 0.35),
	"ψ": Color(0.86, 0.71, 0.54),
	"Ω": Color(0.13, 0.21, 0.35),
	"α": Color(0.32, 0.51, 0.35),
	"°": Color(0.10, 0.20, 0.36),
